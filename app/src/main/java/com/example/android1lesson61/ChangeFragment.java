...
private IFragments listener;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container,
        ...
        btnFirst=view.findViewById(R.id.buttonFirst);
        btnSecond=view.findViewById(R.id.buttonSecond);
        textView=view.findViewById(R.id.textViewFirstFragment);
        if (mParam1!=null){
        ...
        btnFirst.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                text.setText("Hello MainActivity!");
            }
        });
